    ...
    return (
        <div className='body-divout'>
            <div className='body-divin'>
                <div className='d-flex bg-white justify-content-between border-bottom px-3 py-2' style={{ position: "fixed", top: "3px", width: "80%" }}>
                ...
                <div>
                    {allUsers && allUsers?.map((item) => {
                        return (
                            <div
                                key={item._id}
                                className='d-flex justify-content-between pointer p-3 shadow rounded mt-1'
                                onClick={() => {
